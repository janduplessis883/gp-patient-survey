...
html2 = """
    ...
    <div class="gradient-text">Brompton Health PCN - GP Patient Survey 2024</div>

    """
# Using the markdown function with HTML to center the text


# Define your password - remember, this is just for demonstration and not secure for production!
PASSWORD = "2024"
...
# If not authenticated, show the password field and submit button
if not st.session_state["authenticated"]:
    # Create a text input for password (callback is triggered when the input changes)
    ...
    with st.expander("Get access"):
        email = st.text_input(
            "Enter email to gain access.", placeholder="Your email address..."
        )
        text_object = {
            "to": "+447486321744",
            "message": f"GP Patient Survey ACCESS REQUEST: Email - {email}",
        }
...
# If authenticated, display the app's main content
if st.session_state["authenticated"]:
    html = """
    <style>
    .gradient-text {
    ...
    surgery_data = [
        {
            "surgery": "Earls Court Medical Centre",
            "list_size": 6817,
            "prev_survey": 103,
        },
        {"surgery": "Earls Court Surgery", "list_size": 4129, "prev_survey": 113},
        {
            "surgery": "Emperor's Gate Health Centre",
            "list_size": 6909,
            "prev_survey": 103,
        },
        {
        ...
        {
            "surgery": "Knightsbridge Medical Centre",
            "list_size": 17495,
            "prev_survey": 127,
        },
        ...
        {
            "surgery": "The Abingdon Medical Practice",
            "list_size": 8855,
            "prev_survey": 113,
        },
    ...
    Below the chart is a multi-select field where you can choose to filter and review the feedback based on these emotion labels. This feature allows you to delve deeper into the qualitative data, understanding the nuances behind the ratings patients have given and potentially uncovering areas for improvement in patient experience."""
        ...
        selected_ratings = st.multiselect(
            "Select Feedback Categories:", cleaned_class_list
        )
    ...
    # == Generate ChatGPT Summaries ==========================================================
        ...
        def call_chatgpt_api(text):
            ...
            completion = client.chat.completions.create(
                ...
                messages=[
                    ...
                    {
                        "role": "user",
                        "content": f"Summarize the follwing text\n\n{text}",
                    },
                ],
            )
        ...
        if st.button(
            "Summarize with GPT4", help="Click to start generating a summary."
        ):
            if user_input:
                ...
                st.write(summary)
                st.download_button(
                    "Download GPT-4 Output",
                    summary,
                    help="Download summary as a TXT file.",
                )
